...
elif curl -fsSL --retry 3 --retry-delay 2 -o /tmp/deploy-glauth-ldap.sh https://raw.githubusercontent.com/rhpds/deliver-openshift-ops-day/main/support/07-ldap-authentication/deploy-glauth-ldap.sh; then
  bash /tmp/deploy-glauth-ldap.sh
else
...
elif curl -fsSL --retry 3 --retry-delay 2 -o /tmp/configure-oauth-ldap.sh https://raw.githubusercontent.com/rhpds/deliver-openshift-ops-day/main/support/07-ldap-authentication/configure-oauth-ldap.sh; then
  bash /tmp/configure-oauth-ldap.sh
else
...
elif curl -fsSL --retry 3 --retry-delay 2 -o /tmp/cleanup-ldap.sh https://raw.githubusercontent.com/rhpds/deliver-openshift-ops-day/main/support/cleanup-scripts/cleanup-ldap.sh; then
  bash /tmp/cleanup-ldap.sh
else
