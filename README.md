# deliver-openshift-ops-day

An overview of the OpenShift Ops Day Roadshow workshop including its features and how to deliver it and an opportunity to try important modules.
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/deliver-openshift-ops-day`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/deliver-openshift-ops-day
   ```
3. `cd deliver-openshift-ops-day`
